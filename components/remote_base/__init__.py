...
LacrosseData, LacrosseBinarySensor, LacrosseTrigger, LacrosseAction, LacrosseDumper = declare_protocol(
    "Lacrosse"
)
...
@register_binary_sensor("lacrosse", LacrosseBinarySensor, LACROSSE_SCHEMA)
def lacrosse_binary_sensor(var, config):
    cg.add(
        var.set_data(
            cg.StructInitializer(
                LacrosseData,
